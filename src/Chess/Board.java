...
public class Board extends GridPane implements Move, Serializable {
     ...
     */
    protected Piece[] bPawnArray = 
            new Pawn[WIDTH];
    
    /**
     * Holds all the white pawns in an array.
     */
    protected Piece[] wPawnArray = 
            new Pawn[WIDTH];
     ...
     */
    protected static Piece pieceNode;
     ...
     * Destination piece.
     */
    protected static Piece destPiece;
    ...
    private void getDestinationInfo(MouseEvent click) {
        ...
        if (click.getSource() instanceof Square) {
            ...
            destPiece = (Piece) click.getSource();
    ...
    private void getPieceInfo(MouseEvent click) {
        pieceNode = (Piece) click.getSource();
        if (active) {
